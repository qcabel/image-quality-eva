...
def generalized_gaussian_dist(x, alpha, sigma):
    "MSCN coefficients are distributed as a Generalized Gaussian Distribution (GGD)"
...
def asymmetric_generalized_gaussian(x, nu, sigma_l, sigma_r):
    "empirical histograms of neighboring coefficient producs"
    def beta(sigma):
...
def calculate_brisque_features(image, kernel_size=7, sigma=7/6):
    "feature is a vector with fitting parameters for GGD and AGGD"
